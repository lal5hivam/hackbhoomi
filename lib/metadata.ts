...
export const baseMetadata: Metadata = {
  ...
  authors: [
    { name: "InverThon2.0 Team", url: siteUrl },
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${siteUrl}/Inverthon.png`,
        width: 1200,
        height: 630,
        alt: `${siteName} - Invertis University's gateway to Smart Innovation`,
        type: "image/png"
      },
    ],
  },
...
export const structuredData = {
  ...
  "@graph": [
    ...
    // Educational Event Schema
    {
      ...
      "name": "Inverthon 2.0, Invertis University, Bareilly",
