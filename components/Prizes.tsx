...
const Prizes: React.FC = () => {
  ...
  const prizeData = {
    software: {
      ...
      prizes: [
        { place: '1st Place', amount: 'TBD', label: 'WINNER', color: 'yellow' },
        { place: '2nd Place', amount: 'TBD', label: 'RUNNER-UP', color: 'gray' },
        { place: '3rd Place', amount: 'TBD', label: '2ND RUNNER-UP', color: 'orange' },
      ],
    },
    hardware: {
